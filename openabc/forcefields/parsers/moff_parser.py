...
_moff_amino_acid_charge_dict_2 = dict(ALA=0.0, ARG=1.0, ASN=0.0, ASP=-1.0, CYS=0.0,
                                    GLN=0.0, GLU=-1.0, GLY=0.0, HIS=0.25, ILE=0.0,
...
class MOFFParser_acet(object):
    ...
    def parse_mol(self, get_native_pairs=True, frame=0, radius=0.1, bonded_radius=0.05, cutoff=0.6, box=None,
                  use_pbc=False, exclude12=True, exclude13=True, exclude14=True, exclude_native_pairs=True,
                  mass_dict=_moff_amino_acid_mass_dict, charge_dict=_moff_amino_acid_charge_dict_2, ss=None, ordered_ss_names=['H', 'E']):
        """
        Parse molecule.
